...
const Nav = () => {
  ...
  return (
    <nav className='flex flex-col items-center xl:justify-center gap-y-4 fixed h-max 
      ...
      xl:justify-center gap-y-10 px-4 md:px-40 xl:px-0 h-[80px] xl:h-max py-8 bg-texto/10
          ...
          duration-300`}
             ...
             key={index}>
              ...
              <div className='absolute pr-14 right-0 hidden xl:group-hover:flex'>
                <div className='bg-texto relative flex text-primary items-center p-[6px] rounded-[3px]'>
                  <div className='text-[12px] leading-none font-semibold capitalize'>
                    {link.name}
                  </div>
                  {/* Nome ao lado do menu */}
                  <div className='border-solid border-l-texto border-l-8
